# Fujitsu Launches AI-Driven Platform to Optimize Global Supply Chains
...
**Scraped (UTC):** 2026-02-27T06:55:14+00:00
...
## Summary
Fujitsu launched an AI-driven platform at CES 2026 to optimize global supply chains, alongside AMD's Ryzen AI 400 series for laptops and NVIDIA's Vera Rubin AI platform with H300 GPUs for trillion-parameter models.
...
Summary: Weill Cornell Medicine has announced the launch of a premier initiative, the "AI to Advance Medicine" (AIM) program, aimed at integrating artificial intelligence into clinical care and biomedical research. The program focuses on developing tools for precision medicine, such as AI models that predict disease progression and personalize treatment plans for cancer and cardiovascular health. By fostering collaboration between data scientists and clinicians, AIM seeks to ensure that AI applications are both ethically sound and clinically validated. The initiative represents a major investment in the future of data-driven healthcare in New York City.
...
Summary: Researchers developed a transformer‑based AI model named Delphi‑2M that can predict the progression of 1,256 ICD‑10 “level 3” diseases over decades using past medical history, lifestyle factors, sex, and BMI. Trained on UK Biobank data and validated in a Danish cohort, it can estimate not just whether but when conditions may occur, outperforming age‑and‑sex baseline models. The model also simulates life‑long disease trajectories and shows pr
