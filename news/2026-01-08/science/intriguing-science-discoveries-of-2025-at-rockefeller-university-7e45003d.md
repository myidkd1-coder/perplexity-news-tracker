# Intriguing Science Discoveries of 2025 at Rockefeller University

**Category:** Science
**Source:** [https://www.rockefeller.edu/news/38720-intriguing-science-discoveries-of-2025/](https://www.rockefeller.edu/news/38720-intriguing-science-discoveries-of-2025/)
**Publisher:** The Rockefeller University
**Authors:** December
**Published:** 2025-12-18
**Scraped (UTC):** 2026-01-08T03:56:03+00:00

![Article Image](https://www.rockefeller.edu/news/uploads/www.rockefeller.edu/sites/13/2025/12/Strickland_HERO_TEASER.jpg)

## Summary
Rockefeller University researchers reported multiple 2025 advances, including new ways to switch on T cells to revive a once-stalled cancer immunotherapy and strategies to clear toxic proteins at synapses to combat neurodegeneration and extend lifespan in model organisms. Other work uncovered how newly evolved ‘de novo’ genes are regulated, revealed mechanisms of hearing and language emergence, and introduced MagIC cryo-EM, which uses magnetic nanobeads to vastly reduce sample loss for high-resolution structural biology. Collectively, the discoveries span evolution, mechanobiology, obesity, and antibiotic discovery.
...
T cell immunotherapies hold enormous promise, yet they have been effective for only a subset of cancers—largely because scientists have lacked a clear understanding of how these treatments work at the molecular level. This year, Thomas Walz’s lab filled in crucial knowledge gaps in our understanding of T cell activation. By studying the T cell receptor (TCR) in a membrane environment that mirrors its native state, the team discovered that the receptor sits in a compact, closed configuration until it encounters an antigen, at which point it snaps open and triggers signaling inside the cell.

The findings provide a new framework for understanding why T cell therapies fail in some cancers, and suggest new routes for improving them by fine-tuning how T cells are activated. Beyond cancer, the structures may also inform vaccine design by clarifying how different antigens engage the TCR, underscoring the translational power of this fundamental insight.

“The T cell receptor is really the basis of virtually all oncological immunotherapies, so it’s remarkable that we use the system but really have had no idea how it actually works—and that’s where basic science steps in,” says Walz. “This is some of the most important work to ever come out of my lab.”

Revising our understanding of long-term memory

How does the brain decide which experiences become lasting memories, and which quietly fade away? This year, Priya Rajasethupathy’s lab showed that long-term memory is not governed by a single on-off switch, as previously assumed, but by a cascade of molecular timers unfolding across multiple brain regions. The team found that memories are first formed in the hippocampus, then evaluated and stabilized through the thalamus, and ultimately reorganized in the cortex—each step controlled by gene-regulating programs that operate on distinct timescales to either promote persistence or allow forgetfulness.

The findings emphasize the central role of the thalamus as a hub that helps determine whether memories advance toward long-term storage. By replacing the classic switch-based view of memory with a dynamic, multi-stage process, their research explains how the brain remains flexible—retaining important experiences while letting others fade. And by pinpointing molecular programs that preserve memory over days, weeks, or longer, the study offers a new framework for understanding, and perhaps one day treating, memory-related disorders.

“What we choose to remember is a continuously evolving process, rather than a one-time flipping of a switch,” Rajasethupathy says.
