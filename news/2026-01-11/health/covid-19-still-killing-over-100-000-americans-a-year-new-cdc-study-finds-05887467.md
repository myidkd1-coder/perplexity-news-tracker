# COVID-19 Still Killing Over 100,000 Americans a Year, New CDC Study Finds

**Category:** Health
**Source:** [https://kffhealthnews.org/morning-briefing/friday-january-9-2026/](https://kffhealthnews.org/morning-briefing/friday-january-9-2026/)
**Publisher:** KFF Health News (via Newsweek coverage)
**Authors:** - Timothy Kelley, .Wp-Block-Kff-Common-Authors Font-Size Var --Fs-Body-Md, .Wp-Block-Kff-Common-Authors .Wp-Block-Kff-Common-Authors__Name Margin-Block-Start Var, .Wp-Block-Kff-Common-Authors__List Display Flex Flex-Direction Column Gap Var, .Wp-Block-Kff-Common-Authors__Name Margin-Block .Wp-Block-Kff-Common-Authors__Link .Wp-Block-Kff-Common-Authors__Name A Color Var --C-Text-Hover, Text-Decoration None .Wp-Block-Kff-Common-Authors__Link Hover .Wp-Block-Kff-Common-Authors__Name A Hover Color Var --C-Text-Action-Hover, Text-Decoration Underline .Wp-Block-Kff-Common-Authors__Link Align-Items Center Display Flex Gap Var, Margin-Block .Wp-Block-Kff-Common-Authors__Image Block-Size Inline-Size Position Relative .Wp-Block-Kff-Common-Authors__Image After Background Var --C-Surface-Secondary, Block-Size, Content
**Published:** 2026-01-09
**Scraped (UTC):** 2026-01-11T04:21:23+00:00

![Article Image](https://kffhealthnews.org/wp-content/uploads/sites/2/2023/04/kffhealthnews-icon.png?w=32)

## Summary
A new CDC analysis shows COVID-19 continues to kill more than 100,000 people annually in the U.S., exceeding the average yearly death toll from seasonal influenza. The findings underscore that, despite the end of the acute pandemic phase, the virus remains a major ongoing public health threat and highlights the need for sustained vaccination and prevention efforts.
